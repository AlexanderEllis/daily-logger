(function () {
  ...
  // Export the electron remote functionality for node processes
  if (typeof module !== 'undefined' && module.exports) {
          isNode = true;
          root.remote = require('electron').remote;
  } else {
          root.remote = null;
  }
})();
...
function notifyMe() {
  ...
  if (!("Notification" in window)) {
    ...
    notification.onclick = () => {
      ...
      // If we're in electron, we need to show the "browser" window
      if (this.remote) {
...
function submitLog() {
  ...
  // If running Electron, auto-hide window after a few seconds and show countdown
